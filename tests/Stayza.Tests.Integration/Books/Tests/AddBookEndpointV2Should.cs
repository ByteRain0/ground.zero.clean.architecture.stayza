    ...
    IAsyncLifetime
{
    ...
    private RabbitMqTestMessageConsumer _consumer;
    ...
    public AddBookEndpointV2Should(RabbitMqLessApplicationFactory webApplicationFactory)
    {
        ...
        _consumer = webApplicationFactory._consumer;
    }
    ...
    public async Task Add_new_book_should_publish_domain_event()
    {
        ...
        var consumption = await _consumer.BindAndConsumeAsync(
        ...
        // Assert
        (await consumption).ShouldBeTrue();
    }
